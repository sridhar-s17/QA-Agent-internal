...
class QAGraph(BaseModel):
    ...
    """
    nodes: List[QANode] = Field(description="List of QA nodes in the graph. Each node represents a QA automation phase with specific selenium functions.")
    edges: List[QAEdge] = Field(description="List of edges defining the QA workflow flow. Edges connect nodes in execution order.")
    # guided_journey: str = Field(description="Guided journey for the QA automation in markdown format. Describes the complete test flow.")
